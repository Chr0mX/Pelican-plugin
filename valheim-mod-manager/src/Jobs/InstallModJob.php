...
class InstallModJob implements ShouldQueue
{
    ...
    public function handle(ModInstaller $installer): void
    {
        try {
            ...
            $this->notify(
                trans('valheim-mod-manager::strings.notifications.install_success'),
                trans('valheim-mod-manager::strings.notifications.install_success_body', [
            ...
            $this->notify(
                trans('valheim-mod-manager::strings.notifications.install_failed'),
            ...
            // serving a pre-install cached scan for up to 15 seconds.
